...
if (!function_exists('app_url')) {
    function app_url()
    {
        $saas = config('akshyaraait.saas_module_name', 'Saas');
        $module_check_function = config('akshyaraait.module_status_check_function', 'moduleStatusCheck');
...
function moduleVerify($file, $type = null)
{
    ...
    $params = [
        ...
        'akshyaraapayuser' => Storage::exists('.account_email') ? Storage::get('.account_email') : null,
        'tariq' => true,
    ];
