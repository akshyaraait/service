            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('service.license') }}" id="content_form">
                        ...
                        <div class="form-group">
                            <label class="required" for="akshyaraapay_email">{{ __('service::install.akshyaraapay_email') }}</label>
                            <input type="email" class="form-control" name="akshyaraapay_email" id="akshyaraapay_email" value="{{ old('akshyaraapay_email', request('akshyaraapay_email')) }}" required="required" placeholder="{{ __('service::install.akshyaraapay_email') }}" >
                        </div>
